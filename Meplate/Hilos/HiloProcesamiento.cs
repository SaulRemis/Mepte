...
namespace Meplate
{
    class HiloProcesamiento: SpinThreadEvent
    {
        ...
        {
             ((SharedData<Resultados>)SharedMemory["Resultados"]).Set(0, new Resultados(_Proc.Z, _Proc.columnas, _Proc.Pixeles, _Proc.numeroMedidas, _Proc.distancia_a_la_chapa));

...
namespace SpinPlatform.Comunicaciones
{
    ...
    {
        /// <summary>
        /// Módulo para comunicación CLIENTE-SERVIDOR
        /// Éste módulo realiza la conexión bien como cliente o como servidor que se especifica en el archivo de configuración. En el mismo se lanza uno o dos hilos si es servidor (HiloComunicaciones e HiloComunicacionesAccept)
        /// HiloComunicaciones es el encargado de recibir del socket y enviar el aviso por evento al hilo que haya instanciado al módulo sobre la llegada de datos
        /// HiloComunicacionesAccept es el encargado de gestionar las conexiones de clientes al servidor.
        /// Así mismo tiene habilitados los siguientes métodos:
        /// Envío de datos en formato BYTE[]
        /// Checkeode estado del socket (abierto-cerrado)
        /// NOTA: Para su uso es necesario realizar un "Init" deconfiguración. Posteriormente se lanzan los hilos con un "Start" para comenzar a usar "SetData" o "GetData"
        /// Se cierra el módulo con un "Stop"
        /// </summary>
        #region Variables
        ...
        /// <param name="initData">
        /// Campos Obligatorios:  \n
        /// COMThread (thread) \n Hilo padre que instancia el módulo
        /// COMThreadName (string) \n Nombre del hilo padre
        /// COMSocketType (string) \n Tipo de socket (cliente-servidor)
        /// COMPort (string) \n Puerto de conexión
        /// COMIP (string) \n IP de conexión
        /// COMBufferSize (int) \n Tamaño del buffer de escritura-lectura
        /// COMTryconnectiontimes (int) \n Número de veces que el cliente se intenta conectar con el servidor antes de desistir
        /// </param>
        ...
        /// Inicia los hilos del módulo.En el caso del servidor, se pone a la escucho y de ser cliente se intenta conectar
        /// </summary>
        public void Start()
        {
        ...
        /// <summary>
        /// Para el Módulo de  COMUNICACIONES
        /// Termina todos los hilos creados
        /// </summary>
        ...
        private void EstadoDelSocket(dynamic Data)
        {

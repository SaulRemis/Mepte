...
namespace SpinPlatform
{
    ...
    public class CryptoHelp
    {
        ...
        public static string GetDriveVolumeProperties(string strDriveLetter)
        {
            uint serNum = 0;
            uint maxCompLen = 0;
        ...
        public static void DecryptFileToMemory(string inFile, string password, MemoryStream fout) // , CryptoProgressCallBack callback)
        {
            // NOTE:  The encrypting algo was so much easier...
            ...
            using (FileStream fin = File.OpenRead(inFile))
            {
                          ...
                          chash = new CryptoStream(Stream.Null, hasher, CryptoStreamMode.Write))
                {
                    ...
                    String salida = Encoding.ASCII.GetString(fout.GetBuffer(), 0, 39);
        ...
        public static void DecryptMemory(MemoryStream fin, string outFile, string password) //, CryptoProgressCallBack callback)
        {
            // NOTE:  The encrypting algo was so much easier...

...
namespace SpinPlatform
{
    namespace IO
    {
        ...
        {
            /// <summary>
            /// Módulo auxiliar para la carga del archivo de configuración del programa (Implementado parcialmente)
            /// Métodos Init, Start, SetData y Stop (Sin implementar) GetData no sigue la estructura estipulada. Revisar su funcionamiento manualmente
            /// </summary>
